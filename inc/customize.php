...
function remove_footer_admin () {
    echo "SEKOPAK by Morph Networks";
} 
...
function my_login_logo() { ?>
    <style type="text/css">
        .login h1 a {
            background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/img/logos/login-logo.jpg)!important;
...
return array(
  ...
  'edit.php', // Posts
  'edit.php?post_type=testimonials', // Custom type five  
  'edit.php?post_type=cities', // Custom type five  
  'edit.php?post_type=products', // Custom type five  
  'edit.php?post_type=accessories', // Custom type five  
  'edit.php?post_type=industry', // Custom type five  
...
#adminmenu div.wp-menu-name {
    border-bottom:1px dotted #b2ccde!important;
}
...
#adminmenu li.wp-has-submenu.wp-not-current-submenu:hover:after {
  border-right-color:#3cabfa!important;
}
