...
?>
	...
	<section id="industries-intro" class="discount-intro">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
				<header>
    ...
    <?php if( have_rows('content_layout_ind_page') ): ?>
        <?php while( have_rows('content_layout_ind_page') ): the_row(); ?>
            <?php if( get_row_layout() == 'content_blocks' ): ?>
                ...
                <div id="industries-content" class="discount-page">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <?php if (get_sub_field('layout_type') == 'Image Left') { ?>
                                    ...
                                    <section class="services-list-box">
                                        ...
                                        <div class="container">
                                            ...
                                            <img src="<?php bloginfo('template_directory'); ?>/img/bg/green-shape.png" alt="" class="mobile-shape">
